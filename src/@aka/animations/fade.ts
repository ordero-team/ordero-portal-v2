...
import { AkaAnimationCurves, AkaAnimationDurations } from '@aka/animations/defaults';
...
const fadeIn = trigger('fadeIn', [
  ...
  transition('void => *', animate('{{timings}}'), {
    params: {
      timings: `${AkaAnimationDurations.ENTERING} ${AkaAnimationCurves.DECELERATION_CURVE}`,
    },
  }),
]);
...
const fadeOut = trigger('fadeOut', [
  ...
  transition('* => void', animate('{{timings}}'), {
    params: {
      timings: `${AkaAnimationDurations.EXITING} ${AkaAnimationCurves.ACCELERATION_CURVE}`,
    },
  }),
]);
