...
@Injectable()
export class AkaMediaWatcherService {
   ...
   * Constructor
   */
  constructor(private _breakpointObserver: BreakpointObserver, private _akaTailwindConfigService: AkaTailwindService) {
    this._akaTailwindConfigService.tailwindConfig$
      .pipe(
        switchMap((config) =>
