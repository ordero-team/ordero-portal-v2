...
import { AkaHighlightService } from '@aka/components/highlight/highlight.service';

@Component({
  selector: 'textarea[aka-highlight]',
  templateUrl: './highlight.component.html',
  styleUrls: ['./highlight.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  exportAs: 'akaHighlight',
})
export class AkaHighlightComponent implements OnChanges, AfterViewInit {
  @Input() code: string;
  @Input() lang: string;
  ...
  constructor(
    ...
    private _akaHighlightService: AkaHighlightService,
  ...
  private _highlightAndInsert(): void {
    ...
    this.highlightedCode = this._domSanitizer.sanitize(
      ...
      this._akaHighlightService.highlight(this.code, this.lang)
    );
