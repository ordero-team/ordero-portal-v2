...
import { AkaMockApiReplyCallback } from '@aka/lib/mock-api/mock-api.types';

export class AkaMockApiHandler {
  request!: HttpRequest<any>;
  urlParams!: { [key: string]: string };

  // Private
  private _reply: AkaMockApiReplyCallback = undefined;
   ...
   * @param callback
   */
  reply(callback: AkaMockApiReplyCallback): void {
    // Store the reply
