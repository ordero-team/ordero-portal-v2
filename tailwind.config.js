...
const generatePalette = require(path.resolve(__dirname, 'src/@aka/tailwind/utils/generate-palette'));
...
const config = {
      ...
      typography: (theme) => ({
        DEFAULT: {
          css: {
            ...
            'ul > li::before': {
              backgroundColor: 'var(--aka-text-hint)',
            },
            hr: {
            ...
            blockquote: {
              color: 'var(--aka-text-default)',
              borderLeftColor: 'var(--aka-border)',
            },
            h1: {
              color: 'var(--aka-text-default)',
            },
            ...
            thead: {
              color: 'var(--aka-text-default)',
              borderBottomColor: 'var(--aka-border)',
            },
            'tbody tr': {
              borderBottomColor: 'var(--aka-border)',
            },
  ...
  variants: {
    ...
    animation: [],
    backdropFilter: ['hover', 'focus', 'dark'],
